        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div
              ...
              className="sliderCard group relative mx-auto aspect-[452/561] w-full max-h-[calc(55vh-210px)] sm:max-h-[calc(60vh-250px)] md:max-h-[calc(60vh-250px)] lg:max-h-[calc(70vh-230px)] 2xl:h-[215px] 2xl:max-h-[210px] cursor-pointer overflow-hidden"
            >
              <img
                src={slide.thumb}
                alt={slide.title}
