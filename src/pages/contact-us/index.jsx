        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-lg font-athena text-greenTheme">
              We’re here to help you find your dream home. Reach out to us for
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-creamBg p-8 rounded-lg shadow-lg">
              ...
              <p className="mt-4 text-greenTheme">
                This isn’t just about finding a home. It’s about embracing
                slower mornings, greener surroundings, and spaces that feel
                naturally in rhythm. A journey begins here toward something
                quieter, something lasting.
              </p>
              <div className="mt-6">
                {/* Email Section */}
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-lg font-medium text-greenTheme">
                      Email Us
                    </p>
                ...
                <div className="flex items-center space-x-4 mt-4">
                  ...
                  <div>
                    ...
                    <p className="text-greenTheme">
                      Lumora Estates Private Limited 8th Floor, <br /> KR
                      Signature Tower, Sector 135, <br /> Noida, Uttar Pradesh
                      201304
                    </p>
                  </div>
                </div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-greenTheme"
                    >
                      Full Name
                    </label>
                    <input
